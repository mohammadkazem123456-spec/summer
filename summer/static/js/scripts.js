...
if (contactForm) {
    contactForm.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            const res = await fetch('/contact-ajax/', {
                method: 'POST',
                headers: {
            ...
            try {
                ...
                console.error("خطا در parse کردن JSON:", jsonError);
                responseDiv.style.color = 'red';
                responseDiv.textContent = 'خطا در دریافت پاسخ سرور';
                return;
            }
            ...
            if (res.ok && data.status === 'success') {
                ...
                responseDiv.style.color = 'red';
                if (data.errors) {
                    responseDiv.textContent = Object.values(data.errors).flat().join(' | ');
                } else {
                    responseDiv.textContent = data.message || 'حدث خطأ';
                }
            }
            ...
            responseDiv.style.color = 'red';
            responseDiv.textContent = 'حدث خطأ في الإرسال';
        } finally {
